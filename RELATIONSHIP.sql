...
-- 1. Exercício 1: Crie uma consulta que recupere todos os clientes e as interações que eles tiveram. Utilize LEFT JOIN para incluir todos os clientes, mesmo aqueles sem interações.
SELECT * 
FROM clientes
