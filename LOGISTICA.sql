...
-- 1. Exercício 1: Crie uma consulta para listar todos os produtos e seus fornecedores, incluindo produtos sem fornecedores. Utilize LEFT JOIN entre as tabelas de produtos e fornecedores.
SELECT produtos.*, fornecedores.nome 
FROM produtos
